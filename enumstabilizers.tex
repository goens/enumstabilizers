...
%% \begin{theorem}
%% For the Rains enumerators $A'_i, B'_i$ of a quantum Code $C$ it holds that $B'_i \geq A'_i \geq 0$, where equality $B'_i = A'_i$ holds for $i \in \underline{d}$ if and only if $C$ has minimal distance $d$.
%% \begin{proof}
